...
public class TensorFlowYoloDetectorContent implements Classifier {
 ...
 */
  private static final String[] LABELS = {
   //     "Label"
  "Calories", "Total Fat", "Saturated Fat", "Cholesterol", "Sodium", "Total Carbohydrate", "Dietary Fiber", "Vitamin A", "Calcium", "Iron", "Vitamin C", "Content", "Vitamin D", "Protein", "Vitamin E"
  };
  ...
  public static Classifier create(
      ...
      final int blockSize) {
    TensorFlowYoloDetectorContent d = new TensorFlowYoloDetectorContent();
    ...
    try {
      inputStream = assetManager.open("image_to_label.pb");
      ...
      rd.close();
      Log.e("printing log", response.toString());
  ...
  private TensorFlowYoloDetectorContent() {}
